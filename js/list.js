...
function GetBooking() {
    let url = 'https://api.sheety.co/d3e3d2afdc3a06e956741d2f211a8530/bookingSite/booking';
    fetch(url)
...
function DeleteBooking(id) {
    let url = 'https://api.sheety.co/d3e3d2afdc3a06e956741d2f211a8530/bookingSite/booking/2' + id;
    fetch(url, {
        method: 'DELETE',
    })
        .then(() => {
